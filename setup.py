...
RESOLVER_NAME = 'sceptre-myip-resolver'
# the resolver call in sceptre e.g. !command_name.
RESOLVER_COMMAND_NAME = 'myip'
...
RESOLVER_DESCRIPTION = 'A Sceptre resolver to get the callers public IP'
# if multiple use a single string with comma separated names.
RESOLVER_AUTHOR = 'craighurley'
# if multiple use single string with commas.
RESOLVER_AUTHOR_EMAIL = 'none@example.com'
RESOLVER_URL = 'https://github.com/craighurley/{}'.format(RESOLVER_NAME)
